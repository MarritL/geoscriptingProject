...
environmentalURL = "https://drive.google.com/uc?export=download&id=1vNgOAR-2HtXKpdfZTRsiJW4bMsHTbOjR"
```
...
movementSDF <- SpatialPointsDataFrame(coords = coords, data = selectedMovementDataNoNA, proj4string = CRS(proj4))
str(movementSDF)
```
