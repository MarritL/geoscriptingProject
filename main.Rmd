...
m <- leaflet() %>% 
  ...
  # Overlay groups
  addPolylines(data = trajectAgostino, group = 'Agostino') %>% 
  addPolylines(data = trajectAlessandra, group = 'Agostino') %>% 
  addPolylines(data = trajectDaniela, group = 'Agostino') %>% 
  addPolylines(data = trajectDecimo, group = 'Agostino') %>% 
  addPolylines(data = trajectAgostino, group = 'Agostino') %>% 
  addLayersControl(
