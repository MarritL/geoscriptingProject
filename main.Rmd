...
p6 <- ggplot(groups, aes(x=id, y=timeDifference, fill = id)) + geom_boxplot(alpha=0.2) + theme(legend.position = "none") + ggtitle("Time between relocations")
...
p6 <- ggplot(groupsCleaned, aes(x=id, y=timeDifference, fill = id)) + geom_boxplot(alpha=0.2) + theme(legend.position = "none") + ggtitle("Time between relocations")
