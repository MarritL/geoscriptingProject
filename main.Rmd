...
#heightDiff <- heightDEM$DEM_be75 - groupsCleaned$height
DEMheight <- heightDEM$DEM_be75
GPSheight <- groupsCleaned$height
heightData <- data.frame(group = rep(c("DEM height", "GPS height"), each = 10974), height = c(DEMheight, GPSheight))
# Compute summary statistics by groups
summaryHeight <- group_by(heightData, group) %>%
  summarise(
