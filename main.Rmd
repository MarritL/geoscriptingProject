...
environmentalURL = "https://drive.google.com/uc?export=download&id=1HrcmkbPJvKdzEj_xhXEVLiSHz4vJmr1n"
...
simLandCombiDF <- stack(data.frame(simLandCombi[[1]]))
simLandCombiDFLegend <- left_join(simLandCombiDF, (landUseLegend), by = c("values" = "GRID_CODE"))
