...
levelplot(DEM, main = "Altitude of recorded roe deer locations", margin = FALSE, par.settings=myTheme, xlim = c(647000, 670000), key = list(space = 'bottom', points = list(lty = 1, col = colorsAnimals), text = names )) + 
    latticeExtra::layer({
...
# start for reclassificatin table
from <- 1
to <- as.integer()
start <- 1
clas <- as.integer()
